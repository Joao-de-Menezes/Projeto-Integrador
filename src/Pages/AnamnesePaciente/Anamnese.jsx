...
function Anamnese(props) {
    ...
    //antecedentes familiares (pode descartar)
    const [alergiaFamilia, setAlergiaFamilia] = useState('');
    const [quemAlergiaFamilia, setQuemAlergiaFamilia] = useState('');
    const [cardiopatiaFamilia, setCardiopatiaFamilia] = useState('');
    const [quemCardiopatiaFamilia, setQuemCardiopatiaFamilia] = useState('');
    const [hemofiliaFamilia, setHemofiliaFamilia] = useState('');
    const [quemHemofiliaFamilia, setQuemHemofiliaFamilia] = useState('');
    const [diabeteFamilia, setDiabeteFamilia] = useState('');
    const [quemDiabeteFamilia, setQuemDiabeteFamilia] = useState('');
    const [maeRubeola, setMaeRubeola] = useState('');
    const [outroRubeola, setOutroRubeola] = useState('');
    const [quemOutroRubeola, setQuemOutroRubeola] = useState('');
    ...
    const handleSubmit = async (event) => {
        ...
        const anamneseData = {
            ...
            alergiaFamilia, quemAlergiaFamilia,
            cardiopatiaFamilia, quemCardiopatiaFamilia,
            hemofiliaFamilia, quemHemofiliaFamilia,
            diabeteFamilia, quemDiabeteFamilia,
            maeRubeola: maeRubeola ? 'SIM' : 'NAO',
            outroRubeola, quemOutroRubeola
        };
            ...
            >
                ...
                >
                    ...
                    <FormControl paddingTop={4} flexDirection={"column"}>
                        ...
                        <CustomVStack>
                            <Checkbox w="10%" isChecked={alergiaFamilia === "SIM"} onChange={() => setAlergiaFamilia("SIM")} >Sim</Checkbox>
                            <Checkbox w="10%" isChecked={alergiaFamilia === "NAO"} onChange={() => setAlergiaFamilia("NAO")} >Não</Checkbox>
                            <Text w="80%" fontSize="md">Alergias?</Text>
                        </CustomVStack>
                        <CustomVStack>
                            <Text w="30%" fontSize="md">Se sim, quem?</Text>
                            <Input value={quemAlergiaFamilia} onChange={e => setQuemAlergiaFamilia(e.target.value)}
                            id="medicamento" type="text" />
                        </CustomVStack>
                        <CustomVStack>
                            <Checkbox w="10%" isChecked={cardiopatiaFamilia === 'SIM'} onChange={() => setCardiopatiaFamilia('SIM')} >Sim</Checkbox>
                            <Checkbox w="10%" isChecked={cardiopatiaFamilia === 'NAO'} onChange={() => setCardiopatiaFamilia('NAO')} >Não</Checkbox>
                            <Text w="80%" fontSize="md">Cardiopatias?</Text>
                        </CustomVStack>
                        <CustomVStack>
                            <Text w="30%" fontSize="md">Se sim, quem?</Text>
                            <Input value={quemCardiopatiaFamilia} onChange={e => setQuemCardiopatiaFamilia(e.target.value)}
                            id="medicamento" type="text" />
                        </CustomVStack>
                        <CustomVStack>
                            <Checkbox w="10%" isChecked={hemofiliaFamilia === 'SIM'} onChange={() => setHemofiliaFamilia('SIM')} >Sim</Checkbox>
                            <Checkbox w="10%" isChecked={hemofiliaFamilia === 'NAO'} onChange={() => setHemofiliaFamilia('NAO')} >Não</Checkbox>
                            <Text w="80%" fontSize="md">Hemofilia?</Text>
                        </CustomVStack>
                        <CustomVStack>
                            <Text w="30%" fontSize="md">Se sim, quem?</Text>
                            <Input value={quemHemofiliaFamilia} onChange={e => setQuemHemofiliaFamilia(e.target.value)}
                            id="medicamento" type="text" />
                        </CustomVStack>
                        <CustomVStack>
                            <Checkbox w="10%" isChecked={diabeteFamilia === 'SIM'} onChange={() => setDiabeteFamilia('SIM')} >Sim</Checkbox>
                            <Checkbox w="10%" isChecked={diabeteFamilia === 'NAO'} onChange={() => setDiabeteFamilia('NAO')} >Não</Checkbox>
                            <Text w="80%" fontSize="md">Diabetes?</Text>
                        </CustomVStack>
                        <CustomVStack>
                            <Text w="30%" fontSize="md">Se sim, quem?</Text>
                            <Input value={quemDiabeteFamilia} onChange={e => setQuemDiabeteFamilia(e.target.value)}
                            id="medicamento" type="text" />
                        </CustomVStack>
                        <CustomVStack>
                        <Checkbox w="10%" isChecked={maeRubeola === 'SIM'} onChange={() => setMaeRubeola('SIM')} >Sim</Checkbox>
                        <Checkbox w="10%" isChecked={maeRubeola === 'NAO'} onChange={() => setMaeRubeola('NAO')} >Não</Checkbox>
                            <Text w="80%" fontSize="md">Mãe teve rubeola próxima a gravidez?</Text>
                        </CustomVStack>
                        <CustomVStack>
                            <Checkbox w="10%" isChecked={outroRubeola === 'SIM'} onChange={() => setOutroRubeola('SIM')} >Sim</Checkbox>
                            <Checkbox w="10%" isChecked={outroRubeola === 'NAO'} onChange={() => setOutroRubeola('NAO')} >Não</Checkbox>
                            <Text w="80%" fontSize="md">Outros?</Text>
                        </CustomVStack>
                        <CustomVStack>
                            <Text w="30%" fontSize="md">Se sim, quem e o que?</Text>
                            <Input value={quemOutroRubeola} onChange={e => setQuemOutroRubeola(e.target.value)}
                            id="medicamento" type="text" />
                        </CustomVStack>
                    </FormControl>
                    <Button
